...
export class ThemeService implements IThemeService {
	...
	private _setTheme(theme: ITheme = {}): void {
		...
		colors.cursorAccent = color.blend(
			colors.background,
			parseColor(theme.cursorAccent, DEFAULT_CURSOR_ACCENT)
		);
		colors.selectionBackgroundTransparent = parseColor(
		...
		colors.selectionInactiveBackgroundTransparent = parseColor(
		...
		colors.selectionForeground = theme.selectionForeground
			? parseColor(theme.selectionForeground, NULL_COLOR)
			: undefined;
...
function parseColor(cssString: string | undefined, fallback: IColor): IColor {
