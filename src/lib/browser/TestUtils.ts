...
import { type IBufferLine, type ICellData, type IAttributeData, type ICircularList, type XtermListener, type ICharset, type ITerminalOptions, type ColorIndex } from '$lib/common/Types';
...
import { IUnicodeService, IOptionsService, ICoreService, IMouseStateService } from '$lib/common/services/Services';
...
import { type ISelectionRedrawRequestEvent, type ISelectionRequestScrollLinesEvent } from '$lib/browser/selection/Types';
