...
describe('Linkifier2', () => {
  ...
  beforeEach(() => {
    ...
    linkifier = new TestLinkifier2(document.createElement('div'), null!, null!, bufferService, new LinkProviderService());
  ...
  it('onShowLinkUnderline event range is correct', () => new Promise<void>(done => {
  ...
  it('onHideLinkUnderline event range is correct', () => new Promise<void>(done => {
  ...
  it('onShowLinkUnderline event range is correct for wrapped links', () => new Promise<void>(done => {
    linkifier.onShowLinkUnderline(e => {
  ...
  it('onHideLinkUnderline event range is correct for wrapped links', () => new Promise<void>(done => {
    linkifier.onHideLinkUnderline(e => {
      expect(e.x1).toBe(multiLineLink.range.start.x - 1);
      expect(e.y1).toBe(multiLineLink.range.start.y - 1);
      expect(e.x2).toBe(multiLineLink.range.end.x);
