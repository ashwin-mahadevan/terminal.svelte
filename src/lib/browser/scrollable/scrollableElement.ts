...
import type {
	IScrollableElementChangeOptions,
	IScrollableElementCreationOptions,
	IScrollableElementResolvedOptions
} from './scrollableElementOptions';
...
export class SmoothScrollableElement extends Widget {
	...
	public constructor(
		...
		const scrollbarHost: IScrollbarHost = {
			handleMouseWheel: (mouseWheelEvent: StandardWheelEvent) =>
				this._handleMouseWheel(mouseWheelEvent),
	...
	private _setListeningToMouseWheel(shouldListen: boolean): void {
		...
		if (shouldListen) {
			...
			this._mouseWheelToDispose.push(
				dom.addDisposableListener(this._listenOnDomNode, dom.eventType.MOUSE_WHEEL, onMouseWheel, {
					passive: false
				})
			);
		}
		...
		if (e.deltaY || e.deltaX) {
			...
			if (
				...
				const canPerformSmoothScroll =
					this._options.mouseWheelSmoothScroll && classifier.isPhysicalMouseWheel();
	...
	private _render(): void {
		...
		if (this._options.useShadows) {
			...
			this._topLeftShadowDomNode!.setClassName(
				`xterm-shadow${topLeftClassName}${topClassName}${leftClassName}`
			);
		}
	}
...
function resolveOptions(
	opts: IScrollableElementCreationOptions
): IScrollableElementResolvedOptions {
	const result: IScrollableElementResolvedOptions = {
		...
		alwaysConsumeMouseWheel:
			typeof opts.alwaysConsumeMouseWheel !== 'undefined' ? opts.alwaysConsumeMouseWheel : false,
		scrollYToX: typeof opts.scrollYToX !== 'undefined' ? opts.scrollYToX : false,
		mouseWheelScrollSensitivity:
			typeof opts.mouseWheelScrollSensitivity !== 'undefined'
				? opts.mouseWheelScrollSensitivity
				: 1,
		fastScrollSensitivity:
			typeof opts.fastScrollSensitivity !== 'undefined' ? opts.fastScrollSensitivity : 5,
		scrollPredominantAxis:
			typeof opts.scrollPredominantAxis !== 'undefined' ? opts.scrollPredominantAxis : true,
		mouseWheelSmoothScroll:
			typeof opts.mouseWheelSmoothScroll !== 'undefined' ? opts.mouseWheelSmoothScroll : true,

		listenOnDomNode: typeof opts.listenOnDomNode !== 'undefined' ? opts.listenOnDomNode : null,

		horizontal: typeof opts.horizontal !== 'undefined' ? opts.horizontal : ScrollbarVisibility.AUTO,
		horizontalScrollbarSize:
			typeof opts.horizontalScrollbarSize !== 'undefined' ? opts.horizontalScrollbarSize : 10,
		horizontalSliderSize:
			typeof opts.horizontalSliderSize !== 'undefined' ? opts.horizontalSliderSize : 0,
		horizontalHasArrows:
			typeof opts.horizontalHasArrows !== 'undefined' ? opts.horizontalHasArrows : false,

		vertical: typeof opts.vertical !== 'undefined' ? opts.vertical : ScrollbarVisibility.AUTO,
		verticalScrollbarSize:
			typeof opts.verticalScrollbarSize !== 'undefined' ? opts.verticalScrollbarSize : 10,
		verticalHasArrows:
			typeof opts.verticalHasArrows !== 'undefined' ? opts.verticalHasArrows : false,
		verticalSliderSize:
			typeof opts.verticalSliderSize !== 'undefined' ? opts.verticalSliderSize : 0,
