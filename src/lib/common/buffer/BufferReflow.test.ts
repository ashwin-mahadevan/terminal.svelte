...
describe('BufferReflow', () => {
  describe('reflowSmallerGetNewLineLengths', () => {
    ...
    it('should return correct line lengths for a large line with wide characters', () => {
      ...
      expect(reflowSmallerGetNewLineLengths([line], 12, 11), 'line: 汉语汉语汉, 语').toEqual([10, 2]);
      expect(reflowSmallerGetNewLineLengths([line], 12, 10), 'line: 汉语汉语汉, 语').toEqual([10, 2]);
      ...
      expect(reflowSmallerGetNewLineLengths([line], 12, 5), 'line: 汉语, 汉语, 汉语').toEqual([4, 4, 4]);
      expect(reflowSmallerGetNewLineLengths([line], 12, 4), 'line: 汉语, 汉语, 汉语').toEqual([4, 4, 4]);
      expect(reflowSmallerGetNewLineLengths([line], 12, 3), 'line: 汉, 语, 汉, 语, 汉, 语').toEqual([2, 2, 2, 2, 2, 2]);
      expect(reflowSmallerGetNewLineLengths([line], 12, 2), 'line: 汉, 语, 汉, 语, 汉, 语').toEqual([2, 2, 2, 2, 2, 2]);
    });
    it('should return correct line lengths for a string with wide and single characters', () => {
      ...
      expect(reflowSmallerGetNewLineLengths([line], 6, 2), 'line: a, 汉, 语, b').toEqual([1, 2, 2, 1]);
    });
    it('should return correct line lengths for a wrapped line with wide and single characters', () => {
      ...
      expect(reflowSmallerGetNewLineLengths([line1, line2], 6, 5), 'lines: a汉语, ba汉, 语b').toEqual([5, 4, 3]);
      expect(reflowSmallerGetNewLineLengths([line1, line2], 6, 4), 'lines: a汉, 语ba, 汉语, b').toEqual([3, 4, 4, 1]);
      expect(reflowSmallerGetNewLineLengths([line1, line2], 6, 3), 'lines: a汉, 语b, a汉, 语b').toEqual([3, 3, 3, 3]);
      expect(reflowSmallerGetNewLineLengths([line1, line2], 6, 2), 'lines: a, 汉, 语, ba, 汉, 语, b').toEqual([1, 2, 2, 2, 2, 2, 1]);
    });
