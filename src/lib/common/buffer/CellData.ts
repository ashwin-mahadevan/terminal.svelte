...
import type { IBufferCell as IBufferCellApi } from '$lib/xterm';
...
export class CellData extends AttributeData implements ICellData {
	...
	public attributesEquals(other: IBufferCellApi): boolean {
		if (
			this.getFgColorMode() !== other.getFgColorMode() ||
			this.getFgColor() !== other.getFgColor()
		) {
			return false;
		}
		if (
			this.getBgColorMode() !== other.getBgColorMode() ||
			this.getBgColor() !== other.getBgColor()
		) {
			return false;
		}
...
if (import.meta.vitest) {
	...
	const { Attributes, BgFlags, FgFlags, UnderlineStyle } =
