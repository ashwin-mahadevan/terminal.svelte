...
import type { Terminal, ITerminalAddon, IUnicodeHandling } from '$lib/xterm';
import type { UnicodeGraphemesAddon as IUnicodeGraphemesApi } from '$lib/addon-unicode-graphemes';
